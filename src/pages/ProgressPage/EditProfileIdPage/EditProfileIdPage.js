...
import { editProfileIdProgress } from "../../../services/ProgressService";
import { getProfileById } from "../../../services/ProfileService";

const EditProfileIdPage = () => {
  ...
  const handleSubmit = () => {
    ...
    editProfileIdProgress(id, profileId, profile)
      .then(() => {
        console.log("Edit profile");
        message.success("Hồ sơ dự án đã được chỉnh sửa thành công");
        // navigate(`progress/profile/detail/${id}`);
      })
      .catch((error) => {
...
export default EditProfileIdPage;
